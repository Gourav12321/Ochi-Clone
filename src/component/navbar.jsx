...
function Navbar() {
  ...
  return (
    <div className="flex justify-between items-center py-[1vw] px-[4vw] fixed w-full z-50">
      <div className="">
      ...
      <div className="links flex gap-9 pt-2">
      ...
      {showMenu && (
        <div className="md:hidden absolute top-[4.5vw] right-[4vw] bg-white p-4 rounded-lg shadow-lg">
          <ul>
